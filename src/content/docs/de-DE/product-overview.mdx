...
<CardGrid>
  ...
  <LinkCard
    ...
    description='Auf Steam ansehen. Sie können es einzeln kaufen, um die maximale Parallelität von Vorschlägen von 3 auf 32 zu erhöhen, die Unterstützung für den Kopierwechsel freizuschalten, fünf Avatar-Pakete mit jeweils 10 eigenständigen Avataren hinzuzufügen, benutzerdefinierte Avatar-Uploads zu ermöglichen und das Logo und den Titel oben links anzupassen. Wenn Sie den kombinierten Kaufpfad „Steam-Hauptedition + Turbo Engine DLC“ wünschen, verwenden Sie den separaten HagiCode Plus-Bundle-Eintrag.'
  />
  <LinkCard
    title="@@TR_1383@@"
    href="https://store.steampowered.com/app/4625540/HagiCode/"
