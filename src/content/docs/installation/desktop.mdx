...
- **GLM**：访问 [智谱 AI 开放平台](https://open.bigmodel.cn/)
- **MiniMax**：访问 [MiniMax 开放平台](https://www.minimaxi.com/)
- **阿里云**：访问 [阿里云百炼](https://bailian.console.aliyun.com/)
:::
