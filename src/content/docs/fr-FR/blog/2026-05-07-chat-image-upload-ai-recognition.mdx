...
La solution partagée dans cet article provient de notre expérience pratique dans le projet [HagiCode](https://www.hagicode.com). HagiCode est un projet d'assistant de codage IA open source, utilisant une conception de workflow basée sur OpenSpec, s'efforçant de fournir une expérience de codage plus intelligente.
