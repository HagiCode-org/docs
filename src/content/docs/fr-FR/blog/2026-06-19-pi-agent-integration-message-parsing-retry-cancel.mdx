...
> La solution présentée dans cet article provient du projet [HagiCode](https://www.hagicode.com) – un assistant de code AI qui prend en charge plusieurs modèles et plusieurs backends d'agent CLI. Dépôt GitHub : [HagiCode-org/site](https://github.com/HagiCode-org/site), n'hésitez pas à mettre une étoile. Tout le code et tous les problèmes rencontrés décrits ci-dessous sont réellement utilisés dans ce projet. En fait, c'est juste pour se souvenir de tout.
