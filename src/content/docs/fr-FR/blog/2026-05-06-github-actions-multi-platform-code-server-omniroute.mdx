...
La solution présentée dans cet article provient de l'expérience pratique du projet [HagiCode](https://www.hagicode.com). HagiCode est un projet d'assistant de code IA qui intègre code-server comme runtime intégré dans son produit de bureau, nécessitant donc de résoudre les problèmes techniques de construction et de publication multiplateforme. En fin de compte, c'est juste pour sortir le produit, rien de plus.
