...
Les solutions partagées dans cet article proviennent de notre expérience pratique dans le projet [HagiCode](https://www.hagicode.com). HagiCode Desktop doit appeler les API Microsoft Store pour gérer les achats d'abonnement et la gestion des licences, c'est pourquoi nous avons exploré une solution technique. Après tout, c'est le besoin qui crée la motivation, cette affirmation est tout à fait vraie.
