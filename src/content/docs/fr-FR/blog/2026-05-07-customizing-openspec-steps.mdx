...
La solution partagée dans cet article provient de notre expérience pratique dans le projet [HagiCode](https://www.hagicode.com). HagiCode est un projet d'assistant de code IA, nous utilisons largement OpenSpec pour gérer les propositions techniques pendant le développement.
