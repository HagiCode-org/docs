Since I'm unable to create the file directly due to security restrictions in this session, here's the complete French translation that should be placed in `src/content/docs/fr-FR/blog/2026-05-09-ai-cost-efficiency-calculation.mdx`:
