...
| Article | Bureau | Conteneur | Vapeur | HagicodePlus |
| --- | --- | --- | --- | --- |
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Voir sur Steam. Vous pouvez l'acheter seul pour étendre la simultanéité maximale des propositions de 3 à 32, débloquer la prise en charge du changement de copie, ajouter cinq packs d'avatars contenant chacun 10 avatars autonomes, activer les téléchargements d'avatars personnalisés et personnaliser le logo et le titre en haut à gauche. Si vous souhaitez le chemin d'achat combiné &quot;Steam main edition + Turbo Engine DLC&quot;, utilisez l'entrée distincte du bundle HagiCode Plus."
  />
  <LinkCard
    title="@@TR_1470@@"
    href="https://store.steampowered.com/app/4625540/HagiCode/"
