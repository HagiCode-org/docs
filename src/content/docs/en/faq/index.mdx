...
If you need to confirm which Node Desktop uses or why diagnostics mention `portable-fixed/toolchain`, open [Desktop Node Environment](/en/faq/desktop-node-environment).
