...
The initialization wizard turns the most important first-run setup work into one guided sequence. Instead of repeating the full installation guide, this page stays with the three managed screenshots that explain the current onboarding flow most clearly.
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="After project creation, continue into the proposal-driven planning and execution flow."
  />
  <LinkCard
