...
![AI Combined Commit Button](../../img/ai-compose-commit/ai组合提交如何，点击按钮即可触发.png)
...
![Second Confirmation Dialog](../../img/ai-compose-commit/二次确认.png)
...
![AI Processing Complete](../../img/ai-compose-commit/✓ 处理完成.png)
