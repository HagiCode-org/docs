...
Docker Compose Builder is now available as a standalone tool at [https://builder.hagicode.com/](https://builder.hagicode.com/). Use that site as the main source for generating the same class of configuration files.
:::

:::tip[Use Configuration Generator]
You can use [Docker Compose Builder (standalone site)](https://builder.hagicode.com/) to generate `docker-compose.yml` directly.
...
[Open the generator →](https://builder.hagicode.com/)
:::
...
- all required services can start together (PostgreSQL + Hagicode)
...
Now you have successfully deployed Hagicode. Next, connect a real project in the web interface, then continue with [Wizard Setup](/en/quick-start/wizard-setup) or [Create Proposal Session](/en/quick-start/proposal-session).
