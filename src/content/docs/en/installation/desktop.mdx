...
For the latest HagiCode local installation flow, you usually do not need to install PostgreSQL manually in advance. Only review the PostgreSQL guide if you plan to use an external database, follow an advanced deployment path, or connect HagiCode to a separately managed database.
:::
...
![Select Region](../../img/screenshots/installation/install-desktop/03-select-installation-region/original.png)
...
![AI Installation Wizard](../../img/screenshots/installation/install-desktop/04-ai-installation-wizard/original.png)
...
![AI Installation in Progress](../../img/screenshots/installation/install-desktop/05-ai-installation-in-progress/original.png)

![Installation Complete](../../img/screenshots/installation/install-desktop/06-ai-installation-result/original.png)

![Confirm Success](../../img/screenshots/installation/install-desktop/07-confirm-installation-success/original.png)
...
![Create Project Wizard](../../img/screenshots/installation/install-desktop/10-create-project-wizard/original.png)
...
![Import Git Repository](../../img/screenshots/installation/install-desktop/11-import-git-repository/original.png)
