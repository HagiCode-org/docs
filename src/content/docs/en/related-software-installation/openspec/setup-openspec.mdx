...
### Application in PCode Projects

In PCode projects, OpenSpec is used for:
...
<LinkCard title="Create First Project" href="/en/quick-start/create-first-project"
    description="Initialize your Hagicode project, configure basic settings, and start your AI-assisted development journey."
/>
...
3. Refer to [PCode Documentation Site](https://github.com/pcode/pcode-docs) for help