...
For the latest default HagiCode local setup, you usually do not need to install PostgreSQL manually first. Continue only if you explicitly plan to connect HagiCode to a separately managed PostgreSQL instance.
:::
...
:::tip
In most cases, PostgreSQL 16 or newer is the simplest choice.
:::
