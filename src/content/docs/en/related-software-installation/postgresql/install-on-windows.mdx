...
description: This guide will help you install and configure PostgreSQL database on Windows.
sidebar_position: 10
---
...
After PostgreSQL installation is complete, [return to the Installation Guide](/en/installation) to continue configuration.
