...
This guide explains in detail how to install Node.js runtime environment on Windows, macOS, and Linux operating systems. Node.js is a core dependency required for running PCode.

:::tip[Version Requirements]
PCode recommends using **Node.js 24+** (minimum supported Node.js >= 18.0). It is recommended to install the latest LTS version for best performance and security. After installation, please verify that your version meets this requirement.
:::
...
<LinkCard title="Install Claude Code" href="/en/related-software-installation/claude-code/setup-claude-code-with-domestic-providers"
    description="Install Claude Code AI-assisted development tool and experience the smart programming assistant."
/>
...
2. Check [GitHub Issues](https://github.com/pcode/pcode-docs/issues) for similar problems
3. Visit our [Community Forum](https://github.com/pcode/pcode-docs/discussions) for help
