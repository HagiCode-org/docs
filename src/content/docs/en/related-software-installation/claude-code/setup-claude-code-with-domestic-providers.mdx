...
## Choose a subscription website first

If you have not decided which provider to buy yet, start with [AI Service Subscriptions](/en/ai-service-subscriptions/). The new chapter gathers the currently recommended subscription entry points into one top-level section, so you can compare first and then return here to finish Claude Code configuration.

<CardGrid>

<LinkCard title="View the subscription overview" href="/en/ai-service-subscriptions/"
    description="Compare ZAI, MiniMax, Alibaba Cloud DashScope, and Volcengine Coding Plan from one place."
/>

<LinkCard title="Open a provider detail page" href="/en/ai-service-subscriptions/zai"
    description="If you already lean toward a provider, open its dedicated page first and then come back here for the exact Claude Code setup steps."
/>
