...
tags:
  ...
  - Feishu
draft: false
description: This tutorial explains how to install and use Hermes, including the one-line install command, basic CLI usage, model configuration, and the minimum steps for Feishu gateway integration.
seo:
