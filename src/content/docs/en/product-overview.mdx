...
- **Connect to multiple AI tools** including Codex, Claude, OpenCode, CodeBuddy, and iFlow
...
<CardGrid>
  <LinkCard
    ...
    href="/en/quick-start/create-first-project"
    description="Import a repository, initialize project settings, and start using Hagicode."
  />
  <LinkCard
