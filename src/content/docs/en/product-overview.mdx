...
import heroOutlineScout from '../img/product-overview/hero-feature-showcase/hero-outline-scout.webp';
import heroInkMonk from '../img/product-overview/hero-feature-showcase/hero-ink-monk.webp';
import heroRuneMage from '../img/product-overview/hero-feature-showcase/hero-rune-mage.webp';
import heroGadgetAlchemist from '../img/product-overview/hero-feature-showcase/hero-gadget-alchemist.webp';
import heroPaperRanger from '../img/product-overview/hero-feature-showcase/hero-paper-ranger.webp';
import heroAstralTactician from '../img/product-overview/hero-feature-showcase/hero-astral-tactician.webp';
import heroShadowWarden from '../img/product-overview/hero-feature-showcase/hero-shadow-warden.webp';
import heroCrystalGuardian from '../img/product-overview/hero-feature-showcase/hero-crystal-guardian.webp';

export const heroFeatureShowcaseEntries = [
  {
    src: heroOutlineScout.src,
    alt: 'Line-art hooded scout hero avatar',
    name: 'Outline Scout Captain',
    caption: 'quick scans / fast confirmation',
  },
  {
    src: heroInkMonk.src,
    alt: 'Ink-wash monk style hero avatar',
    name: 'Ink Monk Captain',
    caption: 'review / design calibration',
  },
  {
    src: heroRuneMage.src,
    alt: 'Sticker-style rune mage hero avatar',
    name: 'Rune Mage Support',
    caption: 'prompt boosts / execution cues',
  },
  {
    src: heroGadgetAlchemist.src,
    alt: 'Sticker-style gadget alchemist hero avatar',
    name: 'Gadget Alchemist Support',
    caption: 'AutoTask experiments / tuning',
  },
  {
    src: heroPaperRanger.src,
    alt: 'Paper-cut ranger style hero avatar',
    name: 'Paper Ranger Captain',
    caption: 'light exploration / multi-round trials',
  },
  {
    src: heroAstralTactician.src,
    alt: 'Astral fox tactician hero avatar',
    name: 'Astral Tactician Captain',
    caption: 'prompt dungeon / style workbench',
  },
  {
    src: heroShadowWarden.src,
    alt: 'Dark wolf guardian hero avatar',
    name: 'Shadow Warden Guard',
    caption: 'regression pressure / fallback watch',
  },
  {
    src: heroCrystalGuardian.src,
    alt: 'Crystal-armored battle report guardian avatar',
    name: 'Crystal Guardian',
    caption: 'result rollup / battle mood',
  },
];
...
Hagicode currently supports multiple mainstream AI assistant systems:
...
- **OpenCode**: Best for teams that want a dedicated runtime, HTTP API integration, and shared multi-model orchestration
- **CodeBuddy**: Best for teams that already have access to a CodeBuddy CLI distribution and want to integrate it through ACP stdio mode
- **iFlow**: Best for teams that want an ACP WebSocket-based terminal AI tool managed through HagiCode
...
Beyond the base OpenSpec workflow and read-only/edit dual mode, Hagicode now presents a three-part Smart / Efficient / Interesting narrative in the product experience. The three highlights below cover multi-repository governance, commit automation, and the Hero Dungeon collaboration loop.
...
### Hero Dungeon - Turn daily collaboration into a pushable adventure loop

Hero Dungeon is not decorative gameplay layered on top of the product. It is the Interesting workflow layer that connects Proposal, AutoTask, and the Prompt workbench into one readable adventure loop. Hero Dungeon frames the active dungeon, the Captain Roster assigns the right executor, and Battle Reports turn XP, levels, and execution results into feedback the team can review.

#### How it appears in the workflow

- **Hero Dungeon** - packages proposal drafting, batch execution, and prompt previews into dungeon contexts so the team can see which mission is moving right now.
- **Captain Roster** - assigns the right hero captain and backup members to Proposal, AutoTask, and Prompt dungeons so each stage has a stable executor.
- **Battle Reports** - roll XP, levels, execution outcomes, and dungeon progress into a readable feedback view for retrospectives and daily coordination.
- **Where users meet it** - this loop shows up during proposal work, AutoTask fixes, and prompt style collaboration, so it supports real delivery rather than a standalone decoration.

#### Hero avatar matrix

<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
  {heroFeatureShowcaseEntries.map((hero) => (
    <figure key={hero.src} style={{ margin: 0 }}>
      <img
        src={hero.src}
        alt={hero.alt}
        loading="lazy"
        style={{ width: '100%', aspectRatio: '1 / 1', objectFit: 'cover', borderRadius: '0.9rem' }}
      />
      <figcaption style={{ marginTop: '0.75rem', fontSize: '0.95rem', lineHeight: '1.5' }}>
...
<LinkCard title="Adventure Team Introduction" href="/en/adventure-team-introduction"
    description="Read the screenshot-backed guide for roster planning and dungeon flow."
/>

<LinkCard title="Initialization Wizard Guide" href="/en/guides/initialization-wizard"
    description="Understand profession setup, custom hero defaults, and project creation during first-run onboarding."
/>
