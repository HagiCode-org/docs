...
:::danger[This page is outdated]
This guide documents the older 9-stage proposal session UI workflow and no longer reflects the current product interface or steps. Treat it as historical reference only, and rely on the in-product guidance, the latest quick-start docs, and the current UI for the up-to-date flow.
:::

If you already know the change you want but not the implementation path, start with a proposal session. It uses OpenSpec's structured workflow to turn an idea into executable code.

## Prerequisites

Before using proposal sessions, make sure you have:

- Completed the project creation step in the initialization wizard (see [Wizard Setup](/en/quick-start/wizard-setup))

## What is a Proposal Session?

A proposal session is a structured workflow for turning an abstract idea into executable code.

### Proposal Session vs. Conversation Session

Choose between them by looking at the differences first:
...
![Display of the 9 stages of idea](../../img/screenshots/quick-start/create-proposal-session/03-nine-stage-overview/original.png)
...
![Click new idea button](../../img/screenshots/quick-start/create-proposal-session/01-click-new-proposal-button/original.png)

2. Enter the proposal title
3. Describe what you want to accomplish

![Fill in basic information for the idea](../../img/screenshots/quick-start/create-proposal-session/02-fill-proposal-information/original.png)
...
A short description is enough. AI will expand it into a fuller technical proposal in the next stage.
...
![Automatic description optimization after creating new idea, combining user's description with actual project situation for description optimization](../../img/screenshots/quick-start/create-proposal-session/04-description-optimization-start/original.png)
...
![Effect after description optimization, comparing idea and description](../../img/screenshots/quick-start/create-proposal-session/05-description-optimization-result/original.png)
...
![After description optimization and idea name generation, you can click generate plan to generate a plan about this idea](../../img/screenshots/quick-start/create-proposal-session/06-generate-plan-button/original.png)
...
![Interface showing plan generation in progress](../../img/screenshots/quick-start/create-proposal-session/07-plan-generation-in-progress/original.png)

You can view the generation progress in real-time in the conversation tab:

![Generation process can be viewed in the conversation tab](../../img/screenshots/quick-start/create-proposal-session/08-conversation-tab-generation-progress/original.png)
...
![After plan generation is complete, it will enter review state, and then manual review of the plan is required](../../img/screenshots/quick-start/create-proposal-session/09-review-stage-overview/original.png)

You can click on the tabs to view the generated files and make annotations:

![Planning-related files displayed on tabs](../../img/screenshots/quick-start/create-proposal-session/10-planning-files-tab/original.png)
...
![Click on a specific file to perform inline annotations](../../img/screenshots/quick-start/create-proposal-session/11-inline-comment-on-file/original.png)

### 2. File Annotations

Add feedback at the document level:

![You can also add file-level annotations at the bottom of files](../../img/screenshots/quick-start/create-proposal-session/12-file-level-comment/original.png)
...
![After file annotations, you can click the upper right corner or click the review tab to view current annotation content](../../img/screenshots/quick-start/create-proposal-session/13-review-tab-comment-summary/original.png)

### 3. Global Annotations

Provide overall feedback for the proposal:

![You can also add global annotations unrelated to files in the review tab](../../img/screenshots/quick-start/create-proposal-session/14-add-global-comment/original.png)

**Note**: Global annotations need to click the "Save" button to take effect.

![Global annotations need to click save to take effect](../../img/screenshots/quick-start/create-proposal-session/15-save-global-comment/original.png)
...
![After all annotations are confirmed, you can click the submit all annotations button to let AI modify based on your annotations](../../img/screenshots/quick-start/create-proposal-session/16-submit-all-comments/original.png)

You can view the process of AI processing annotations in the conversation tab:

![After annotation submission, you can see AI modification process in the conversation tab](../../img/screenshots/quick-start/create-proposal-session/17-ai-modification-progress/original.png)
...
1. **Add annotations**: leave feedback on a file, a section, or the overall proposal.
2. **Submit feedback**: the app collects those annotations and sends them back to the AI.
3. **Review the updated plan**: inspect the revised proposal after the AI adjustment.
4. **Decide whether you are satisfied**
   - **No**: return to step 1 and add more annotations.
   - **Yes**: make one more execution decision.
     - **Execute immediately**: move into the execution stage.
     - **Not yet**: keep the current plan and continue refining it later.
...
![After plan is manually confirmed to be correct, you can click execute immediately in the info tab](../../img/screenshots/quick-start/create-proposal-session/18-execute-plan-button/original.png)
...
![Display of plan execution in progress](../../img/screenshots/quick-start/create-proposal-session/19-plan-execution-in-progress/original.png)
...
![Display of stage after plan execution is complete](../../img/screenshots/quick-start/create-proposal-session/20-plan-execution-complete/original.png)

### Review in IDE

Open the project in your preferred IDE for review.

![Code change display after plan execution is complete](../../img/screenshots/quick-start/create-proposal-session/21-code-changes-after-execution/original.png)
...
![If not satisfied with execution results, you can continue to ask AI to modify according to your requirements in the conversation](../../img/screenshots/quick-start/create-proposal-session/22-refine-result-in-chat/original.png)
...
![If all results have achieved satisfactory effects, you can click archive plan to complete the process](../../img/screenshots/quick-start/create-proposal-session/23-archive-plan-button/original.png)

![Archive in progress](../../img/screenshots/quick-start/create-proposal-session/24-archive-in-progress/original.png)
...
![Display of archive complete stage](../../img/screenshots/quick-start/create-proposal-session/25-archive-complete/original.png)

## Stage 8: Archived

The proposal lifecycle is complete. The proposal is now in the archive.

![Code change display after archive is complete](../../img/screenshots/quick-start/create-proposal-session/26-code-changes-after-archive/original.png)
