...
この記事で共有するアプローチは、[HagiCode](https://www.hagicode.com) プロジェクトでの私たちの実践に基づいています。HagiCode は AI コードアシスタントプロジェクトで、Web、Desktop、CLI などの複数の端末をカバーしています。HagiCode Desktop というデスクトップ製品ラインこそが、この記事で議論する対象であり、完全なソースコードは [HagiCode-org/site](https://github.com/HagiCode-org/site) で確認できます。
