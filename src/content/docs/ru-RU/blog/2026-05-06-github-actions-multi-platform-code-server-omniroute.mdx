...
Решение, представленное в этой статье, основано на практическом опыте проекта [HagiCode](https://www.hagicode.com). HagiCode — это проект ИИ-помощника по коду, в его desktop-продукте интегрирован code-server как встроенная среда выполнения, поэтому необходимо решить инженерные задачи мультиплатформенной сборки и публикации. Это, говоря прямо, просто для того, чтобы сделать продукт, и всё.
