...
Схема, описанная в этой статье, основана на нашем опыте в проекте [HagiCode](https://www.hagicode.com). HagiCode — это проект ИИ-помощника для кодирования, охватывающий Web, Desktop, CLI и другие платформы. HagiCode Desktop — это настольная линейка продуктов, обсуждаемая в этой статье, полный исходный код можно посмотреть в репозитории [HagiCode-org/site](https://github.com/HagiCode-org/site).
