---
title: Создание команды приключений AI: Практическое руководство по настройке многоагентного сотрудничества в HagiCode
date: 2026-03-17
tags: [AI, Agent, Сотрудничество, HagiCode, Архитектурное проектирование]
description: "В современной разработке программного обеспечения одиночный AI Agent уже вряд ли сможет удовлетворить сложные требования. Как заставить несколько AI-ассистентов из разных компаний работать вместе в одном проекте? В этой статье мы поделимся опытом проекта HagiCode в реальной разработке"
---

## Создание команды приключений AI: Практическое руководство по настройке многоагентного сотрудничества в HagiCode

> В современной разработке программного обеспечения одиночный AI Agent уже вряд ли сможет удовлетворить сложные требования. Как заставить несколько AI-ассистентов из разных компаний работать вместе в одном проекте? В этой статье мы поделимся решением по настройке многоагентного сотрудничества, которое HagiCode исследовал в реальной разработке.

:::note[Пояснение к временному контексту]
本文记录的是 **2026-03-17 发布时** 的多 Agent 配置实践。当前常驻支持范围已经以后端现行配置为准：Claude Code、Codex、GitHub Copilot、OpenCode、Hermes、QoderCLI、Kiro、Kimi、Gemini、DeepAgents、Codebuddy；其中 `IFlowCli` 现仅保留为历史兼容值，不属于当前活跃支持范围。若你想看当前安装与支持口径，请改看 [AI Agent CLI 安装](/related-software-installation/ai-agent-cli/) 与 [安装指南](/installation)。
:::
...
| IFlowCli | 智谱 | glm-4.7 | 归档提案和历史记录（当时配置；当前仅历史兼容） |
| OpenCodeCli | - | - | 通用代码编辑 |
