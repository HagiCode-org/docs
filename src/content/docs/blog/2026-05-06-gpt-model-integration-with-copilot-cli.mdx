...
本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个 AI 代码助手项目，在开发过程中我们遇到了需要同时支持多种 AI 模型的挑战——有些用户习惯用 GPT-4，有些偏好 Claude，还有些想尝试最新的 GPT-5。如果为每个模型单独实现一套调用逻辑，代码会变得难以维护。通过 Copilot CLI 的统一接口，我们成功解决了这个多模型支持的痛点。
...
- [HagiCode Desktop 快速安装](https://www.hagicode.com/desktop/)
