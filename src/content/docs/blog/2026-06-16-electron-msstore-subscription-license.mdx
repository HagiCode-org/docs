...
本文分享的方案，来自我们在 [HagiCode](https://www.hagicode.com) 项目里的实践。HagiCode 是一个 AI 代码助手项目，涵盖 Web、Desktop、CLI 等多个端。HagiCode Desktop 这条桌面产品线，便是这篇文章讨论的对象，完整源码可以看 [HagiCode-org/site](https://github.com/HagiCode-org/site)。
