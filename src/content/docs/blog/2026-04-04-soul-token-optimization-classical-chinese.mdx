...
description: "在 AI 应用开发中，token 消耗直接影响成本。HagiCode 项目通过 SOUL 系统实现了\"文言文极简输出模式\"，在不损失信息密度的前提下，将输出 token"
---
...
- 原文链接: [https://docs.hagicode.com/blog/2026-04-04-soul-token-optimization-classical-chinese/](https://docs.hagicode.com/blog/2026-04-04-soul-token-optimization-classical-chinese/)
