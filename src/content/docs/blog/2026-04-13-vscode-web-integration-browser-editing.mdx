...
description: "在构建浏览器端的代码编辑能力时，开发者面临一个关键选择：使用 VSCode 官方的 code serve-web 功能，还是采用社区驱动的 code-server 方案"
---
...
本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个 AI 驱动的代码助手，在实现浏览器端代码编辑能力时，我们深入研究了这两个方案，最终在架构设计中同时支持两者，但默认优先选择 code-server。
