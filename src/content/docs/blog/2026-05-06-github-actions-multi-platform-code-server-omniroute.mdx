...
date: 2026-05-07
tags: [omniroute]
description: 介绍 HagiCode 如何用 GitHub Actions 构建 code-server 与 OmniRoute 的多平台流水线，覆盖矩阵构建、产物验证、统一发布与踩坑经验。
---
...
本文分享的方案来自 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个 AI 代码助手项目，在其桌面端产品中集成了 code-server 作为内置运行时，因此需要解决多平台构建和发布的工程问题。这事儿，说白了就是为了把产品做出来，仅此而已。
