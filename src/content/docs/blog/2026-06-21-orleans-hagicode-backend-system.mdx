...
这些东西不是凭空想出来的。本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目里的真刀真枪踩坑经验。HagiCode 是个面向 AI 协作编程的桌面工作台，它的后台要在单进程里协调十几种 AI CLI 工具，还得给前端提供低延迟的实时响应——说白了，就是又要马儿跑，又要马儿不吃草，还要马儿边跑边唱歌。
