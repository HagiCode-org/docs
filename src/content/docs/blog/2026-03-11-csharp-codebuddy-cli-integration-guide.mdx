...
description: "本文将详细介绍如何在 C# 后端项目中集成 CodeBuddy CLI，实现 AI 编程助手能力的完整方案。"
---
...
:::note[时间语境说明]
本文讨论的是发布当时的 CodeBuddy 集成设计与 provider 结构。当前常驻支持范围请以 [AI Agent CLI 安装](/related-software-installation/ai-agent-cli/) 与 [安装指南](/installation) 为准；`IFlowCli` 现仅保留为历史兼容值，不属于当前活跃支持范围。
:::
...
本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个开源的 AI 代码助手项目，支持多种 AI Provider 和跨平台运行。为了满足不同用户的偏好，我们需要能够灵活切换各种 AI 编程助手，这就有了本文要介绍的 CodeBuddy 集成方案。
...
- [HagiCode 项目主页](https://www.hagicode.com)
