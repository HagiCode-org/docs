...
description: "在构建 AI 辅助编码平台时，选择合适的 Agent 核心直接决定了系统能力的天花板。毕竟有些事情，勉强不来——选错了框架，怎么折腾都不得劲。本文分享 HagiCode"
---
...
本文分享的方案来自 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个 AI 辅助编码平台，通过 VSCode 扩展、桌面客户端和 Web 服务，为开发者提供智能编码助手。或许你也用过类似的工具，只是总觉得差了那么一口气——这我们也理解。
