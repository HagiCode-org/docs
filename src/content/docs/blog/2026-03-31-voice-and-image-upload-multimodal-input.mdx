...
description: "打字不如说话，说话不如截图——AI 代码助手的多模态输入实践：其实写代码这事儿，打字再快也有个上限。有时候说一句话的事，非得敲半天键盘；有时候一张图就能说明白，却得用一"
---

## 打字不如说话，说话不如截图——AI 代码助手的多模态输入实践

> 其实写代码这事儿，打字再快也有个上限。有时候说一句话的事，非得敲半天键盘；有时候一张图就能说明白，却得用一堆文字去描述。本文聊聊我们在做 [HagiCode](https://www.hagicode.com) 时遇到的那些事儿——语音识别也好，图片上传也罢，反正就是想让 AI 代码助手变得好用一点，罢了。
...
本文分享的这些方案，来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践——或者说，是在不断踩坑中摸索出来的经验。
