...
description: "在浏览器中快速编辑代码：VSCode Web 集成实践：AI 分析完代码后，如何立即在浏览器中打开编辑器进行修改？本文分享 HagiCode 项目中集成 code-se"
---
...
本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个 AI 驱动的代码助手，旨在通过自然语言交互提升开发效率。在开发过程中，我们发现用户经常需要在 AI 分析和代码编辑之间快速切换，这促使我们探索如何将编辑器直接集成到浏览器中。
