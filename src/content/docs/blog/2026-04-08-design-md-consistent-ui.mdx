...
description: "在 AI 辅助前端开发时代，如何让 AI 生成的 UI 保持一致性？本文分享了我们基于 awesome-design-md 构建设计画廊站点的实践经验，以及如何创建结构"
---
...
本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个 AI 辅助开发平台，在开发过程中，我们也遇到了 AI 生成 UI 不一致的问题。为了解决这个问题，我们构建设计画廊站点并创建规范化的 design.md，本文就是这套方案的总结。
...
- 访问官网了解更多：[hagicode.com](https://www.hagicode.com)
...
- Desktop 桌面端快速安装：[hagicode.com/desktop/](https://www.hagicode.com/desktop/)
- 公测已开始，欢迎安装体验
