...
本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个基于 AI 的代码助手项目，在开发过程中我们需要集成多个 AI Provider，OpenCode 就是其中之一。下面分享的架构演进过程，都是我们在实际项目中踩坑、优化出来的真实经验，反正也没辙，踩过的坑总得填上。
...
- HagiCode Desktop 桌面端：[hagicode.com/desktop/](https://www.hagicode.com/desktop/)
