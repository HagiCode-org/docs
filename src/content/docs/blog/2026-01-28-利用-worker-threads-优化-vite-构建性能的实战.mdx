...
- **本文链接:** [https://www.hagicode.com/blog/2026/01/27/optimizing-vite-build-with-worker-threads](https://www.hagicode.com/blog/2026/01/27/optimizing-vite-build-with-worker-threads)
