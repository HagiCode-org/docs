...
本文分享的方案，来自我们在 [HagiCode](https://www.hagicode.com) 项目里的实践经验。HagiCode 是一个 AI 代码助手项目，preset task 系统正是它面向用户的快捷操作入口。下面讲的每一处改动，都是我们实际踩坑、实际优化出来的——毕竟纸上得来终觉浅。项目源码在 [HagiCode-org/site](https://github.com/HagiCode-org/site)，感兴趣的可以先去点个 Star。
...
- [HagiCode 官网](https://www.hagicode.com)：了解 HagiCode 的整体能力。
