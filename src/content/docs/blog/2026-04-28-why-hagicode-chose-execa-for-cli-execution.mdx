...
date: 2026-05-05
tags: [Node.js, execa, child_process, HagiCode, 最佳实践]
description: 复盘 HagiCode 为何用 execa 统一 CLI 执行层，涵盖跨平台兼容、错误处理、进程控制与在桌面端和脚本引擎中的落地经验。
---
...
本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个 AI 代码助手项目，需要在多个子项目（Hagiscript 脚本引擎和 Desktop 桌面应用）中执行大量外部命令。这种多语言、多平台的复杂度，或许就是我们引入 execa 的直接原因。
