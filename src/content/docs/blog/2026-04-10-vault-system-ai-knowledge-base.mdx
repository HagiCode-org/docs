...
description: "临摹项目学习法正在成为主流，只是学习资料分散、上下文断裂的痛点让 AI 助手难以发挥最大价值。本文介绍 HagiCode 项目的 Vault 系统设计——通过统一的存储"
---
...
本文分享的方案来自在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。HagiCode 是一个基于 OpenSpec 工作流的 AI 代码助手，它的核心理念是让 AI 不仅会"说"，更会"做"——能够直接操作代码仓库、执行命令、运行测试。GitHub：[github.com/HagiCode-org/site](https://github.com/HagiCode-org/site)
