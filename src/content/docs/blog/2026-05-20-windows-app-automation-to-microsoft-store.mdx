...
date: 2026-05-20
tags: [Windows, Microsoft Store, 自动化, Electron, CI/CD]
description: 复盘 Electron 应用自动上架 Microsoft Store 的完整流程，涵盖版本解析、构建打包、商店提交与自动化发布协调。
---
...
本文分享的方案来自我们在 [HagiCode](https://www.hagicode.com) 项目中的实践经验。作为一个 AI 代码助手，HagiCode 提供桌面端和 Web 端，需要支持多种分发渠道。在实现 Microsoft Store 自动上架的过程中，我们总结出了一套完整的自动化方案。
...
Microsoft Store 自动上架看起来复杂，但拆解成独立步骤后，每一步都不难。关键是：
