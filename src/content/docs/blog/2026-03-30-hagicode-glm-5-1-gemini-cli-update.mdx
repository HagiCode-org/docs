...
- [Desktop 桌面端安装](https://www.hagicode.com/desktop/)

## 继续体验 HagiCode

如果你想直接上手这套多模型、多 CLI 的工作流，可以从下面几个入口开始：

- 在 GitHub 查看项目进展并获取最新代码：[github.com/HagiCode-org/site](https://github.com/HagiCode-org/site)
- 访问官网了解产品路线与安装入口：[hagicode.com](https://www.hagicode.com)
- 观看 30 分钟实战演示，快速感受实际工作流：[www.bilibili.com/video/BV1pirZBuEzq/](https://www.bilibili.com/video/BV1pirZBuEzq/)
- 按 Docker Compose 安装文档完成一键部署：[docs.hagicode.com/installation/docker-compose](https://docs.hagicode.com/installation/docker-compose)
