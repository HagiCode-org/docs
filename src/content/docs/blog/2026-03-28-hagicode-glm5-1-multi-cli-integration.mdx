---
title: Hagicode 联合 GLM-5.1 多 CLI 集成指南
date: 2026-03-28
tags: [hagicode, glm-5.1, cli, opencode, claude-code, ai-programming]
description: "在 Hagicode 项目中，用户可以选择多种 CLI 工具来驱动 AI 编程助手，包括 Claude Code CLI、GitHub Copilot、OpenCode"
---

## Hagicode 联合 GLM-5.1 多 CLI 集成指南

:::note[时间语境说明]
本文记录的是发布当时的多 CLI 接入设计与模型映射。当前常驻支持范围请以 [AI Agent CLI 安装](/related-software-installation/ai-agent-cli/) 与 [安装指南](/installation) 为准；文中的 `IFlowCli` 仅代表当时的历史配置，不属于当前活跃支持范围。
:::
...
- **智谱 AI**：https://www.bigmodel.cn/claude-code?ic=14BY54APZA
...
- 在 GitHub 查看主项目和最新实现进展：[github.com/HagiCode-org/site](https://github.com/HagiCode-org/site)
- 访问官网了解产品路线、能力边界和安装入口：[hagicode.com](https://www.hagicode.com)
- 先按 Docker Compose 文档完成一键部署，再切模型、切 CLI 做实际验证：[docs.hagicode.com/installation/docker-compose](https://docs.hagicode.com/installation/docker-compose)
- 如果你更偏向本地桌面体验，也可以直接从 Desktop 入口开始：[hagicode.com/desktop/](https://www.hagicode.com/desktop/)
