...
- Si una publicación no establece metadatos de idioma explícitos, el idioma se deriva de la ruta del contenido: `src/content/docs/blog/` es `zh-CN`, `src/content/docs/en-US/blog/` es `en-US`y los otros árboles de idiomas usan sus nombres de directorio.
