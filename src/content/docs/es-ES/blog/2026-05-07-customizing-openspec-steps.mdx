...
La solución compartida en este artículo proviene de nuestra experiencia práctica en el proyecto [HagiCode](https://www.hagicode.com). HagiCode es un proyecto de asistente de código con IA, y usamos ampliamente OpenSpec en el proceso de desarrollo para gestionar propuestas técnicas.
