...
<CardGrid>
  ...
  >
    Complete primero el requisito previo del tiempo de ejecución si la máquina aún no tiene una instalación utilizable de Node.js.
  </LinkCard>
  <LinkCard
    título="@@TR_1199@@"
    href="/es-ES/instalación-de-software-relacionado/ai-agent-cli/"
  >
    Complete primero la instalación de la CLI del agente local si su entorno CLI aún no está listo.
  </LinkCard>
  <LinkCard
    título="@@TR_2071@@"
    href="https://github.com/diegosouzapw/OmniRoute"
  >
    Continúe con el repositorio original y las guías oficiales cuando necesite material de referencia más completo.
  </LinkCard>
</CardGrid>
