...
Si no está instalada o la versión es demasiado antigua, consulte las instrucciones de instalación del software relacionado en el [Guía de instalación](/es-ES/installation).
...
3. Consulte las guías relacionadas en el [Sitio de documentación de HagiCode](/es-ES/product-overview) para ayuda adicional
