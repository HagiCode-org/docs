...
![新建提案时选择子仓库](../img/guides/monospecs/新建提案的时候可以选择参考和编辑的仓库.png)
...
![悬停查看仓库详情](../img/guides/monospecs/hover项目的时候展示各个仓库的情况.png)
...
![AI 提交时选择子仓库](../img/guides/monospecs/AI提交的时候可以选择子仓库.png)
