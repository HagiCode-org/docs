...
![Local Skills 标签页中的已安装技能清单与批量操作](../img/screenshots/shared/local-skills-view/original.png)
...
![Gallery 标签页中的搜索结果、来源筛选与安装统计](../img/screenshots/shared/skills-gallary/original.png)
