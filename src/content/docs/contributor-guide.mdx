...
├── ai-compose-commit/        # AI Compose Commit 功能图片
├── monospecs/              # Monospec 功能图片
└── shared/                   # 共享图片资源
```
...
```markdown
<!-- 在 docs 根目录的文件，如 product-overview.mdx -->
<!-- ![产品概述](./img/product-overview/value-proposition-proposal-driven/illustration.png) -->

<!-- 在 quick-start/ 子目录的文件，如 quick-start/conversation-session.mdx -->
...
<!-- 在 guides/ 子目录的文件，如 guides/ai-compose-commit.mdx -->
<!-- ![AI 组合提交](../img/ai-compose-commit/ai组合提交如何，点击按钮即可触发.png) -->
```
