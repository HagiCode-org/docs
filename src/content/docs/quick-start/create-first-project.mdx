...
![点击项目的 SDD tab，可以对 SDD 进行初始化](../img/screenshots/quick-start/create-project/step4-click-sdd-tab/original.png)

2. 点击 **初始化 SDD** 按钮

![初始化完 SDD 之后显示的状态](../img/screenshots/quick-start/create-project/step5-sdd-initialized-status/original.png)
...
![点击优化按钮，可以优化 Project.md](../img/screenshots/quick-start/create-project/step6-click-optimize-button/original.png)
