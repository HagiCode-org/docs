...
이 문서에서 공유하는 솔루션은 [HagiCode](https://www.hagicode.com) 프로젝트에서의 실천 경험에서 나왔습니다. HagiCode는 오픈 소스 AI 코드 어시스턴트 프로젝트로, OpenSpec 기반 워크플로우 설계를 채택하여 더 스마트한 코드 작성 경험을 제공하는 데 주력하고 있습니다.
