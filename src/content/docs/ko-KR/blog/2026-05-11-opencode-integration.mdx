...
이 문서에서 공유하는 방안은 [HagiCode](https://www.hagicode.com) 프로젝트에서의 실무 경험에서 비롯되었습니다. HagiCode는 AI 기반 코드 어시스턴트 프로젝트로, 개발 과정에서 여러 AI Provider를 통합해야 했고, OpenCode도 그중 하나였습니다. 아래에 공유하는 아키텍처 진화 과정은 모두 실제 프로젝트에서 함정을 밟고 최적화해 나온 진정한 경험입니다. 어쩔 수 없죠, 밟은 함정은 메워야 합니다.
...
- HagiCode Desktop 데스크톱: [hagicode.com/desktop/](https://www.hagicode.com/desktop/)
