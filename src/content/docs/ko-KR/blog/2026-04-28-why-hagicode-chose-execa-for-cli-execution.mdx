...
이 문서에서 공유하는 솔루션은 [HagiCode](https://www.hagicode.com) 프로젝트에서의 실전 경험에서 나왔습니다. HagiCode는 AI 코드 어시스턴트 프로젝트로, 여러 하위 프로젝트(Hagiscript 스크립트 엔진 및 Desktop 데스크톱 애플리케이션)에서 많은 외부 명령을 실행해야 합니다. 이러한 다언어, 다플랫폼의 복잡성이 우리가 execa를 도입한 직접적인 이유일 수 있습니다.
