...
A solução compartilhada neste artigo vem da nossa experiência prática no projeto [HagiCode](https://www.hagicode.com). O HagiCode é um projeto de assistente de código IA, usamos amplamente o OpenSpec para gerenciar propostas técnicas durante o desenvolvimento.
