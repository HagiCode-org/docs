...
> 本文分享的方案來自 [HagiCode](https://www.hagicode.com) 項目——一個 AI 代碼助手，支持多模型、多 agent CLI 後端。GitHub 倉庫：[HagiCode-org/site](https://github.com/HagiCode-org/site)，歡迎來點個 Star。下面講的所有代碼、所有踩過的坑，都是這個項目裡真實跑著的。其實寫出來也不過是給自己留個念想而已。
