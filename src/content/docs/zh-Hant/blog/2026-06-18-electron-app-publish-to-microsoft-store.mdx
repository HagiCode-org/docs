...
這篇文章裡講的方案，來自我們在 [HagiCode](https://www.hagicode.com) 專案裡的實踐。HagiCode Desktop 是一個基於 Electron 的桌面端，要同時透過官網、GitHub Release、還有微軟商店這三個渠道分發給用戶。商店這條渠道是怎麼打通的，就是這篇文章要講的事。文末有更多關於 HagiCode 的資訊，要是你感興趣，不妨拉到底看看。
