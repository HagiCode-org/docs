...
本文分享的方案來自我們在 [HagiCode](https://www.hagicode.com) 項目裡的實踐。HagiCode 是一個面向開發者工作流的 AI 代碼助手，把 Git 提交、代碼審查、構建發布這些日常環節都做成了 AI 可參與的任務。下文拆解的提示詞系統，正是 HagiCode 後端裡真實在跑的那一套。說到底，也只是想把那點瑣碎的"收尾活"交給 AI 罷了。
