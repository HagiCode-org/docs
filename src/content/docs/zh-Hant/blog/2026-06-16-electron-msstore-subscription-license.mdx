...
本文分享的方案，來自我們在 [HagiCode](https://www.hagicode.com) 項目裡的實踐。HagiCode 是一個 AI 代碼助手項目，涵蓋 Web、Desktop、CLI 等多個端。HagiCode Desktop 這條桌面產品線，便是這篇文章討論的對象，完整源碼可以看 [HagiCode-org/site](https://github.com/HagiCode-org/site)。
