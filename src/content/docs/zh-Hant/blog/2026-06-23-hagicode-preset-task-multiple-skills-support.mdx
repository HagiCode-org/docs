...
本文分享的方案，來自我們在 [HagiCode](https://www.hagicode.com) 專案裡的實踐經驗。HagiCode 是一個 AI 程式碼助手專案，preset task 系統正是它面向使用者的快捷操作入口。下面講的每一處改動，都是我們實際踩坑、實際優化出來的——畢竟紙上得來終覺淺。專案原始碼在 [HagiCode-org/site](https://github.com/HagiCode-org/site)，有興趣的可以先去點個 Star。
...
- [HagiCode 官網](https://www.hagicode.com)：了解 HagiCode 的整體能力。
