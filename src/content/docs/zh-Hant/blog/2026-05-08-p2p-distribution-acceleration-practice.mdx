...
本文分享的混合分發方案來自我們在 [HagiCode](https://www.hagicode.com) 專案中的實踐經驗。HagiCode Desktop 是我們的桌面端應用程式，支援 Windows、macOS 和 Linux 多平台。作為一個 AI 程式碼助手專案，桌面端需要頻繁更新分發包，這促使我們探索更高效能的分發方式。畢竟，誰也不願意每次更新都要等上半天，不是嗎？
...
- [HagiCode Desktop 安裝指南](https://www.hagicode.com/desktop/)
