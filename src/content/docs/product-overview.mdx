...
| --- | --- | --- | --- | --- |
| 获取入口 | [Desktop 安装](/installation/desktop) | [Container 部署](/installation/docker-compose) | [点击查看](https://store.steampowered.com/app/4625540/Hagicode/) | [点击查看](https://store.steampowered.com/app/4635480/Hagicode__Turbo_Engine/) |
| 定价 | 免费 | 免费 | 点击查看 | 点击查看 |
| 全部免费特性 | ✅ | ✅ | ✅ | ✅ |
| Vault | ✅ | ✅ | ✅ | ✅ |
| Skills | ✅ | ✅ | ✅ | ✅ |
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="点击查看。可单独购买，用来把最大提案并发数从 3 扩展到 32，同时解锁文案切换，附带 5 套每套 10 个的独立头像，并支持上传自定义头像以及自定义左上角 Logo 和 Title；官网常把“Steam 主体 + Turbo Engine DLC”作为 Hagicode Plus 对外说明。"
  />
  <LinkCard
