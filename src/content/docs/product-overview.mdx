...
| --- | --- | --- | --- | --- |
| 获取入口 | [Desktop 安装](/installation/desktop) | [Container 部署](/installation/docker-compose) | [点击查看](https://store.steampowered.com/app/4625540/Hagicode/) | [点击查看](https://store.steampowered.com/bundle/73989/Hagicode_Plus/) |
| 定价 | 免费 | 免费 | 点击查看 | 点击查看 |
| 全部免费特性 | ✅ | ✅ | ✅ | ✅ |
| Vault | ✅ | ✅ | ✅ | ✅ |
| Skills | ✅ | ✅ | ✅ | ✅ |
...
**Hagicode Plus 说明。** Hagicode Plus 是 Steam 上的官方组合包，直接把 Steam 主体版本和 Turbo Engine DLC 放进同一条购买路径里。换句话说，如果你看到 Hagicode Plus，可以把它理解成“Steam 版 + 更高并发与增强能力”的组合购买入口。

**Turbo Engine 头像能力。** Turbo Engine DLC 还包含 5 套独立头像资源，每套提供 10 个单独头像可供选择，并支持上传自定义头像。它补的并不只是并发，也把 Steam 工作台的身份展示和个性化空间一起抬高了一截。
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="点击查看。可单独购买，用来把最大提案并发数从 3 扩展到 32，同时解锁文案切换，附带 5 套每套 10 个的独立头像，并支持上传自定义头像以及自定义左上角 Logo 和 Title；如果你想直接购买“Steam 主体 + Turbo Engine DLC”的组合包，请看 Hagicode Plus 的单独 bundle 入口。"
  />
  <LinkCard
