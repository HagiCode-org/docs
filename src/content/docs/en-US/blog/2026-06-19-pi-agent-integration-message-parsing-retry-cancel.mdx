...
> The solution shared in this article comes from the [HagiCode](https://www.hagicode.com) project—an AI code assistant supporting multiple models and multiple agent CLI backends. GitHub repository: [HagiCode-org/site](https://github.com/HagiCode-org/site), feel free to give it a Star. All the code and pitfalls discussed below are actually running in this project. Writing this out is just leaving a memento for myself.
