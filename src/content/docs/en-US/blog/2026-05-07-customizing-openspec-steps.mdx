...
The solution shared in this article comes from our practical experience in the [HagiCode](https://www.hagicode.com) project. HagiCode is an AI coding assistant project, and we heavily use OpenSpec to manage technical proposals during development.
