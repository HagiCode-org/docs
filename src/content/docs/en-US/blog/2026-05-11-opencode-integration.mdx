...
The solution shared in this article comes from our practical experience in the [HagiCode](https://www.hagicode.com) project. HagiCode is an AI-based code assistant project. During development, we needed to integrate multiple AI Providers, and OpenCode is one of them. The architectural evolution process shared below is all real experience from stepping into pits and optimizing in actual projects. Anyway, there's no other way, the pits that were stepped into must be filled.
