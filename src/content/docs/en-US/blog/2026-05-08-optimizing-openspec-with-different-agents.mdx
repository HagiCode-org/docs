...
The solution shared in this article comes from our practical experience in the [HagiCode](https://www.hagicode.com) project. HagiCode is an AI-driven code assistant, and we heavily use the OpenSpec workflow to manage technical proposals during development. The agent layering strategy introduced in this article is precisely the optimization solution we summarized from actual use.
