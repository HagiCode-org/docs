...
The solution shared in this article comes from our practical experience in the [HagiCode](https://www.hagicode.com) project. HagiCode is an AI code assistant project that needs to execute numerous external commands across multiple subprojects (Hagiscript script engine and Desktop desktop application). This complexity of multiple languages and platforms might be the direct reason we introduced execa.
...
- Desktop desktop client quick install: [hagicode.com/desktop/](https://www.hagicode.com/desktop/)
