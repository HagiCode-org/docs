...
The solution shared in this article comes from our practice in the [HagiCode](https://www.hagicode.com) project. HagiCode is an AI code assistant project covering multiple platforms including Web, Desktop, and CLI. HagiCode Desktop is the desktop product line discussed in this article, and the complete source code can be viewed at [HagiCode-org/site](https://github.com/HagiCode-org/site).
