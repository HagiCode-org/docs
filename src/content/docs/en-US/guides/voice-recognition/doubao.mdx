...
:::tip
**Trial quota**: Doubao Open Platform gives new users **20 hours** of free speech recognition, which is enough to check whether this voice-input flow fits your work.
:::
...
Doubao Voice Input is HagiCode's integrated speech-recognition feature, backed by the ByteDance Doubao Open Platform. You speak, and the system turns speech into text. HagiCode also uses current project context to help recognize domain vocabulary and technical terms more reliably.

### Key Use Cases

In HagiCode, voice input works best for:
...
2. Configure voice recognition in the product
3. Test the API key
4. Find the voice input box
5. Click the microphone button
6. Grant microphone permission
7. Start recording
8. View recognition results in real time
9. Click to stop recording
10. Confirm the text is inserted
