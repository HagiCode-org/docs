---
title: 安装 Node.js
description: 本指南介绍如何在 Windows、macOS 和 Linux 上安装 Node.js，并完成版本检查与常见环境准备。
sidebar_position: 10
---
...
本页说明如何在 Windows、macOS 和 Linux 上安装 Node.js。Node.js 是 HagiCode 本地工具链的重要依赖，OpenSpec、前端工具和部分 CLI 都会用到它。

:::tip[版本要求]
HagiCode 推荐使用 **Node.js 24+**（最低支持 Node.js >= 18.0）。通常直接安装最新 LTS 版本即可。安装完成后，请确认版本满足要求。
:::
...
3. 访问 [HagiCode 官网](https://www.hagicode.com/) 获取最新支持入口
