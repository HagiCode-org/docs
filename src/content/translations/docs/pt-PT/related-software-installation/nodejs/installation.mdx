...
2. Baixe o instalador do Windows **LTS (Long Term Support)** (`.msi` arquivo)
...
<LinkCard title="Instale o OpenSpec" href="/en/related-software-installation/openspec/setup-openspec"
    descrição="@@TR_2077@@"
/>

<LinkCard title="Instalar a CLI do Agente AI" href="/en/related-software-installation/ai-agent-cli/"
    descrição="@@TR_2079@@"
/>

<LinkCard title="Retornar ao Guia de Instalação" href="/en/installation"
    descrição="@@TR_2082@@"
/>
...
2. Revise o [Visão geral do produto HagiCode](/en/product-overview) para o contexto atual do produto e das ferramentas
