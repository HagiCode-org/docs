...
O HagiCode Desktop é fornecido com um conjunto de ferramentas Node gerenciado por Desktop. Ele não assume a instalação global do Node em seu computador. Seu objetivo é fornecer aos fluxos relacionados à inicialização e ao tempo de execução do Desktop uma base de tempo de execução estável e verificável.
