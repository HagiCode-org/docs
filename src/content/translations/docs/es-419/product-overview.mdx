...
HagiCode presenta **MonoSpecs** para traer ese tipo de colaboración entre repositorios nuevamente bajo una sola vista. En un solo proyecto, puede mantener un inventario del repositorio, el alcance de la propuesta y la estrategia de archivo. También puede permitir que la IA comprenda más claramente qué límites cruza realmente un cambio.
...
| --- | --- | --- | --- | --- |
| Punto de entrada | [Instalación de escritorio](/es-419/installation/desktop) | [Implementación de contenedores](/es-419/installation/docker-compose) | [Ver en Steam](https://store.steampowered.com/app/4625540/Hagicode/) | [Ver en Steam](https://store.steampowered.com/bundle/73989/Hagicode_Plus/) |
...
<CardGrid>
  ...
  <LinkCard
    ...
    descripción='Ver en Steam. Puede comprarlo por sí solo para ampliar la simultaneidad máxima de propuestas de 3 a 32, desbloquear la compatibilidad con el cambio de copia, agregar cinco paquetes de avatar con 10 avatares independientes cada uno, habilitar la carga de avatares personalizados y personalizar el logotipo y el título en la parte superior izquierda. Si desea la ruta de compra combinada "Edición principal de Steam + DLC Turbo Engine", utilice la entrada del paquete Hagicode Plus por separado.
  />
  <LinkCard
    título="@@TR_1652@@"
    href="https://store.steampowered.com/app/4625540/Hagicode/"
...
<CardGrid>
  <LinkCard
    título="@@TR_1665@@"
    href="/es-419/guias/monospecs"
    descripción="@@TR_1668@@"
  />
  <LinkCard
    título="@@TR_591@@"
    href="/es-419/guias/habilidades"
    descripción="@@TR_1672@@"
  />
  <LinkCard
    título="@@TR_330@@"
    href="/es-419/guides/ai-compose-commit"
    descripción="@@TR_1676@@"
  />
</CardGrid>
