...
Esta guía cubre la instalación de Node.js en Windows, macOS y Linux. Node.js es una dependencia clave para las herramientas locales de HagiCode, incluidas OpenSpec, herramientas de interfaz y varias CLI para desarrolladores.
...
<LinkCard title="Instalar OpenSpec" href="/en/related-software-installation/openspec/setup-openspec"
    descripción="@@TR_2077@@"
/>

<LinkCard title="Instalar la CLI del Agente AI" href="/en/related-software-installation/ai-agent-cli/"
    descripción="@@TR_2079@@"
/>

<LinkCard title="Volver a la guía de instalación" href="/en/installation"
    descripción="@@TR_2082@@"
/>
...
2. Revisa el [Descripción general del producto HagiCode](/en/product-overview) para el contexto actual de productos y herramientas
