...
- Node.js ya está instalado. completo [Instalación de Node.js](/en/related-software-installation/nodejs/installation) primero si es necesario.
...
<CardGrid>
  <LinkCard
    título="@@TR_1976@@"
    href="/es/instalación-de-software-relacionado/nodejs/instalación"
  >
  ...
  <LinkCard
    título="@@TR_1153@@"
    href="/es/instalación-de-software-relacionado/ai-agent-cli/"
  >
