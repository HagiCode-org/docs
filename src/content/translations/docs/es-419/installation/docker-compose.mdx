...
- **Azure ACR alternativo**: elija la fuente de imagen de Azure ACR solo si otras fuentes de imágenes tienen dificultades de acceso.
...
Ahora ha implementado Hagicode con éxito. A continuación, conecte un proyecto real en la interfaz web y luego continúe con [Configuración del asistente](/es-419/quick-start/wizard-setup) o [Crear sesión de propuesta](/es-419/quick-start/proposal-session).

Si prefiere el método de implementación de la aplicación de escritorio, consulte [Guía de instalación de escritorio](/es-419/installation/desktop).
