...
The solution shared in this article comes from our hands-on experience in the [HagiCode](https://www.hagicode.com) project. HagiCode is an AI-driven coding assistant project, and during development we frequently need to maintain project design documents. To help the team collaborate more efficiently, we explored and implemented this online editing and import solution. There is nothing mysterious about it. We ran into a problem and worked out a way to solve it.
