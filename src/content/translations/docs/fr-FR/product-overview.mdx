...
| Intégration GitHub | ✅ | ✅ | ✅ |
| Gestion de Git | ✅ | ✅ | ✅ |
| Nombre maximal de propositions simultanées | 3 | 3 | 32[^1] |
| Thèmes de documents | ❌ | ❌ | ✅[^1] |
| Paternité de commit personnalisée | ❌ | ❌ | ✅[^1] |
| Personnalisation de marque | ❌ | ❌ | ✅[^1] |
| Téléchargement d'avatar personnalisé | ❌ | ❌ | ✅[^1] |
| Packs d'avatars | ❌ | ❌ | ✅[^1] |

[^1]: Nécessite l'achat de **TurboEngine** pour déverrouiller. TurboEngine est une licence perpétuelle à achat unique dans Microsoft Store (Store ID: `9NSD809W18Z6`). Un achat déverrouille définitivement les fonctionnalités ci-dessus.
