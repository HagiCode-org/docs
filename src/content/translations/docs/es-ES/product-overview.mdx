...
| Integración de GitHub | ✅ | ✅ | ✅ |
| Gestión de Git | ✅ | ✅ | ✅ |
| Propuestas concurrentes máximas | 3 | 3 | 32[^1] |
| Temas de documentos | ❌ | ❌ | ✅[^1] |
| Autoría de commits personalizada | ❌ | ❌ | ✅[^1] |
| Personalización de marca | ❌ | ❌ | ✅[^1] |
| Subida de avatar personalizado | ❌ | ❌ | ✅[^1] |
| Paquetes de avatares | ❌ | ❌ | ✅[^1] |

[^1]: Requiere comprar **TurboEngine** para desbloquear. TurboEngine es una licencia perpetua de compra única en Microsoft Store (Store ID: `9NSD809W18Z6`). Una compra desbloquea permanentemente las funciones anteriores.
