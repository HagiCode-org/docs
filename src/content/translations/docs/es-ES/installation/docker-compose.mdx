...
- **Imagen de Docker Hub**: genera la referencia de imagen compatible de Docker Hub
...
2. Complete la configuración según sus necesidades:
   ...
   - **Usar la imagen de Docker Hub**: el generador configura la imagen compatible de Docker Hub
...
El generador utiliza Docker Hub como fuente de imagen compatible:
