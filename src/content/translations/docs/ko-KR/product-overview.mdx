...
HagiCode가 무엇을 하려고 하는지 이해했다면 다음 실제 질문은 일반적으로 간단합니다. 지금 어떤 에디션으로 시작해야 하며 현재 공개 Windows 채널은 무엇입니까?

아래 표에서는 `✅` 지원됨을 의미하며 `❌` 지원되지 않음을 의미합니다.

| 품목 | 데스크탑 | 컨테이너 | Microsoft Store |
| --- | --- | --- | --- |
| 진입점 | [데스크탑 설치](/ko-KR/installation/desktop) | [컨테이너 배포](/ko-KR/installation/docker-compose) | [Microsoft Store 설치](/ko-KR/installation/windows-store) |
| 가격 | 무료 | 무료 | 무료 |
| 모든 무료 기능 포함 | ✅ | ✅ | ✅ |
| 금고 | ✅ | ✅ | ✅ |
| 기술 | ✅ | ✅ | ✅ |
...
**Windows 채널 상태.** Steam 메인 앱 항목은 이미 퇴역했습니다. 현재 공개 Windows 배포 채널은 Microsoft Store입니다. 배경은 [HagiCode가 Steam에 없는 이유](/ko-KR/faq/steam-distribution-status)에서 확인할 수 있습니다.

**기능 정렬.** 현재 Microsoft Store 에디션은 제안, Vault, Skills, OmniRoute, GitHub 통합, 로컬 업적을 포함한 핵심 워크플로 기능에서 무료 Desktop 기준선과 맞춰져 있습니다.

**설치 경로 안내.** 시스템이 관리하는 설치 및 업데이트 경로를 원한다면 Microsoft Store를 선택하세요. 패키지 출처를 수동으로 제어해야 하거나 Store가 아닌 경로가 필요하다면 [Desktop Installation](/ko-KR/installation/desktop)을 사용하세요.
...
<CardGrid>
  ...
  href="/ko-KR/installation/windows-store"
  description="설치와 패키지 전달을 시스템 스토어가 관리하도록 하려는 경우의 현재 공개 Windows 경로입니다."
/>
  <LinkCard
  title="Steam 배포 상태"
  href="/ko-KR/faq/steam-distribution-status"
  description="Steam 메인 앱 항목이 왜 퇴역했는지와 Windows 채널이 Microsoft Store로 바뀐 배경을 설명합니다."
/>
</CardGrid>
