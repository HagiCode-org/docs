---
title: Skills Guide
description: Learn how to review local skills, search the gallery, inspect install details, and understand trusted providers in HagiCode.
---
...
![Local Skills tab with the installed skills inventory and batch actions](../../img/screenshots/shared/local-skills-view/original.png)
...
![Gallery tab with search results, source filters, and install counts](../../img/screenshots/shared/skills-gallary/original.png)
...
2. Use `Gallery` to search and compare sources
3. Open the details panel to verify trust state and install command
4. If needed, review or adjust trust rules in `Trusted Providers`
