...
:::note[About Default Data Storage]
...
- **Alternative Alibaba Cloud ACR**: Only choose Alibaba Cloud ACR image source if other image sources have access difficulties
...
Now you have successfully deployed Hagicode. Next, connect a real project in the web interface, then continue with [Wizard Setup](/en-US/quick-start/wizard-setup) or [Create Proposal Session](/en-US/quick-start/proposal-session).

If you prefer the desktop application deployment method, please refer to [Desktop Installation Guide](/en-US/installation/desktop).
