...
description: Install Hagicode Desktop on Windows, macOS, or Linux, review system requirements, and complete the first-launch setup for local development.
sidebar_position: 30
---
...
2. **Official Website**: Visit [Hagicode Website](https://www.hagicode.com/) to get download links
...
<LinkCard title="Wizard Setup" href="/en-US/quick-start/wizard-setup"
    description="Complete project creation here after first launch and continue through the canonical quick-start flow."
/>

<LinkCard title="Create a Conversation Session" href="/en-US/quick-start/conversation-session"
    description="Understand the project in default read-only mode, then switch to edit mode only when needed."
/>

<LinkCard title="Create Proposal Session" href="/en-US/quick-start/proposal-session"
