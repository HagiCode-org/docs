...
description: Use the recommended local npm path to install OmniRoute, verify startup, and confirm that the Dashboard and OpenAI-compatible API are available.
sidebar_position: 12
tags:
  - omniroute
  - openai-compatible
...
- Node.js must be `>=22.0.0 <23` or `>=24.0.0 <27`. Node.js 21 and 23 are unsupported. Complete [Installing Node.js](/en/related-software-installation/nodejs/installation) first if needed.
