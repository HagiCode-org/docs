...
- Visit the official site to understand the product direction, capability boundaries, and install options: [hagicode.com](https://hagicode.com)
...
- If you prefer a local desktop workflow, begin with the Desktop entry point: [hagicode.com/desktop/](https://hagicode.com/desktop/)
