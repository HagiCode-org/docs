...
- Track the main project and latest implementation progress on GitHub: [github.com/HagiCode-org/site](https://github.com/HagiCode-org/site)
- Visit the official site to understand the product direction, capability boundaries, and install options: [hagicode.com](https://www.hagicode.com)
- Start with the Docker Compose guide, then switch models and CLIs in a real environment: [docs.hagicode.com/installation/docker-compose](https://docs.hagicode.com/installation/docker-compose)
- If you prefer a local desktop workflow, begin with the Desktop entry point: [hagicode.com/desktop/](https://www.hagicode.com/desktop/)
