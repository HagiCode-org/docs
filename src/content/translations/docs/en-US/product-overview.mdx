...
| GitHub integration | ✅ | ✅ | ✅ |
| Git management | ✅ | ✅ | ✅ |
| Maximum concurrent proposals | 3 | 3 | 32[^1] |
| Document themes | ❌ | ❌ | ✅[^1] |
| Custom commit authorship | ❌ | ❌ | ✅[^1] |
| Branding customization | ❌ | ❌ | ✅[^1] |
| Custom avatar upload | ❌ | ❌ | ✅[^1] |
| Avatar packs | ❌ | ❌ | ✅[^1] |

[^1]: Requires purchasing **TurboEngine** to unlock. TurboEngine is a one-time perpetual license in Microsoft Store (Store ID: `9NSD809W18Z6`). One purchase permanently unlocks the features above.
