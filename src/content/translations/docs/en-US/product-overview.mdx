...
Hello, fellow creators. I'm Kun Yu, the creator of **HagiCode**.
...
Once you understand what HagiCode is trying to be, the next practical question is usually simple: which edition should you start with now, and what is the current public Windows channel?

In the table below, `✅` means supported and `❌` means not supported.

| Item | Desktop | Container | Microsoft Store |
| --- | --- | --- | --- |
| Entry point | [Desktop Installation](/en-US/installation/desktop) | [Container Deployment](/en-US/installation/docker-compose) | [Microsoft Store Installation](/en-US/installation/windows-store) |
...
| GitHub integration | ✅ | ✅ | ✅ |
| Git management | ✅ | ✅ | ✅ |
| Maximum concurrent proposals | 3 | 3 | 3 |
| System store installation | ❌ | ❌ | ✅ |

**Windows channel status.** The main Steam app entry has been retired. Microsoft Store is now the public Windows distribution channel. For background, see [Why HagiCode is not available on Steam](/en-US/faq/steam-distribution-status).

**Capability alignment.** The current Microsoft Store edition aligns with the free Desktop baseline for core workflow capabilities, including proposals, Vault, Skills, OmniRoute, GitHub integration, and local achievements.

**Install path guidance.** If you prefer a system-managed installation and update path, choose Microsoft Store. If you need manual package control or a non-Store route, use [Desktop Installation](/en-US/installation/desktop) instead.

### Current Windows Channel

<CardGrid>
  <LinkCard
    title="Microsoft Store Installation"
    href="/en-US/installation/windows-store"
    description="Use the current public Windows channel if you want installation and package delivery managed through the system store."
  />
  <LinkCard
    title="Steam Distribution Status"
    href="/en-US/faq/steam-distribution-status"
    description="Read why the main Steam app entry was retired and why the Windows distribution channel moved to Microsoft Store."
  />
</CardGrid>
