...
Подход, описанный в этой статье, основан на нашем практическом опыте в проекте [HagiCode](https://www.hagicode.com). HagiCode is an AI-assisted development platform built on the Orleans Grain architecture. It integrates with different AI providers through a unified `IAIProvider` interface, allowing users to flexibly choose the AI tools they prefer.
