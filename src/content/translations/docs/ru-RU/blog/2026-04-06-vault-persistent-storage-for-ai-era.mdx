...
The Vault system shared in this article is exactly the solution we developed while building [HagiCode](https://www.hagicode.com). HagiCode is an AI coding assistant project, and in our daily development work we often need to study and refer to many different open source projects. To help AI assistants better understand these learning resources, we designed Vault, a cross-project persistent storage system.
