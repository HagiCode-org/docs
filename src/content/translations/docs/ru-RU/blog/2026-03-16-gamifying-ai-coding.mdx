...
We ran into exactly this problem while developing [HagiCode](https://www.hagicode.com). As a multi-AI assistant collaboration platform, HagiCode needs to keep users engaged over the long term. But in reality, even a great tool is hard to stick with if it lacks any emotional connection.
...
The ideas shared in this article come from our practical experience on the [HagiCode](https://www.hagicode.com) project. HagiCode is a multi-AI assistant collaboration platform that supports Claude Code, Codex, Copilot, OpenCode, and other AI assistants working together. If you are interested in multi-AI collaboration or gamified programming, visit [github.com/HagiCode-org/site](https://github.com/HagiCode-org/site) to learn more.
