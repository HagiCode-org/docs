...
description: "Building an AI Adventure Party: A Practical Guide to Multi-Agent Collaboration Configuration in HagiCode: In modern software development, a single AI Agent is"
---
...
В этой статье описывается практика мультиагентной конфигурации **на момент выпуска от 2026-03-17**. Текущий долго поддерживаемый объём теперь следует текущей конфигурации бэкенда: Claude Code, Codex, GitHub Copilot, OpenCode, Hermes, QoderCLI, Kiro, Kimi, Gemini, DeepAgents и Codebuddy. Среди них `IFlowCli` в настоящее время сохраняется только в качестве значения обратной совместимости и больше не входит в активно поддерживаемый набор. Для текущего объёма установки и поддержки см. [Установку AI Agent CLI](/en/related-software-installation/ai-agent-cli/) и [Руководство по установке](/en/installation).
:::
