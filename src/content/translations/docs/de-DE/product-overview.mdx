...
| GitHub-Integration | ✅ | ✅ | ✅ |
| Git-Verwaltung | ✅ | ✅ | ✅ |
| Maximale Anzahl gleichzeitiger Vorschläge | 3 | 3 | 3 |
| Installation über den System-Store | ❌ | ❌ | ✅ |

**Status des Windows-Kanals.** Der Haupt-App-Eintrag bei Steam wurde bereits eingestellt. Microsoft Store ist jetzt der öffentliche Windows-Vertriebskanal. Hintergrund dazu finden Sie unter [Warum HagiCode nicht auf Steam verfügbar ist](/de-DE/faq/steam-distribution-status).

**Funktionsabgleich.** Die aktuelle Microsoft-Store-Edition entspricht bei den Kernfunktionen des Workflows der kostenlosen Desktop-Basis, einschließlich Vorschlägen, Vault, Skills, OmniRoute, GitHub-Integration und lokalen Erfolgen.

**Empfehlung für den Installationspfad.** Wenn Sie einen vom System verwalteten Installations- und Updateweg bevorzugen, wählen Sie Microsoft Store. Wenn Sie die Paketquelle manuell steuern müssen oder keinen Store-Kanal verwenden wollen, nehmen Sie stattdessen die [Desktop-Installation](/de-DE/installation/desktop).
