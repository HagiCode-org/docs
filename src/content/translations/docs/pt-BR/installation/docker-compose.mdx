...
- **Imagem do Docker Hub**: gera a referência de imagem compatível do Docker Hub
...
2. Preencha a configuração de acordo com sua necessidade:
   ...
   - **Use a imagem do Docker Hub**: o gerador configura a imagem compatível do Docker Hub
...
O gerador usa o Docker Hub como fonte de imagem compatível:
...
Agora você implantou o HagiCode com sucesso. Em seguida, conecte um projeto real na interface web e continue com [Configuração do assistente](/pt-BR/quick-start/wizard-setup) ou [Criar sessão de proposta](/pt-BR/quick-start/proposal-session).

Se você preferir o método de implantação de aplicativos de desktop, consulte [Guia de instalação de desktop](/pt-BR/installation/desktop).
