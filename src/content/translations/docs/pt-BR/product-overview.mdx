...
| Integração com GitHub | ✅ | ✅ | ✅ |
| Gerenciamento Git | ✅ | ✅ | ✅ |
| Máximo de propostas simultâneas | 3 | 3 | 32[^1] |
| Temas de documentos | ❌ | ❌ | ✅[^1] |
| Autoria de commit personalizada | ❌ | ❌ | ✅[^1] |
| Personalização de marca | ❌ | ❌ | ✅[^1] |
| Upload de avatar personalizado | ❌ | ❌ | ✅[^1] |
| Pacotes de avatares | ❌ | ❌ | ✅[^1] |

[^1]: Requer a compra do **TurboEngine** para desbloquear. O TurboEngine é uma licença perpétua de compra única na Microsoft Store (Store ID: `9NSD809W18Z6`). Uma compra desbloqueia permanentemente os recursos acima.
