...
Se não estiver instalado ou a versão for muito antiga, consulte as instruções de instalação do software relacionado no [Guia de instalação](/pt-BR/installation).
...
3. Consulte os guias relacionados no [Site de documentação do HagiCode](/pt-BR/product-overview) para ajuda adicional
