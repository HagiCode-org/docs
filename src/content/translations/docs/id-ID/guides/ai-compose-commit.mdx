---
title: Panduan Komitmen AI Compose
description: Gunakan AI untuk secara cerdas menghasilkan pesan penerapan Git, sehingga meningkatkan kualitas dan konsistensi penerapan.
---

## Ikhtisar

AI Compose Commit membaca perubahan kode saat ini dan menghasilkan pesan penerapan dalam format Komit Konvensional. Intinya sederhana: habiskan lebih sedikit waktu untuk menulis komitmen sambil menjaga sejarah tetap jelas.

### Apa itu Komitmen AI Compose?

AI Compose Commit menganalisis perubahan Anda dan menulis pesan penerapan standar untuk perubahan tersebut. Ini menukar penulisan komit manual untuk sejarah yang lebih konsisten.

Gunakan ketika:
- Perubahan kode besar memerlukan banyak penerapan
- Proyek multi-repositori dengan perubahan terkoordinasi
- Tim yang membutuhkan format penerapan standar
- Pengembang yang ingin meningkatkan kualitas komitmen

### Keuntungan Utama

| Fitur | Komitmen Manual Tradisional | Komitmen Penulisan AI |
|----------|----------------------|------------------|
| **Komitmenkan Kualitas** | Tergantung pada pengalaman individu | Berdasarkan praktik terbaik, kualitas yang konsisten |
| **Kecepatan Komit** | Memerlukan pemikiran dan pengorganisasian | Sekali klik, pembuatan instan |
| **Konsistensi** | Mungkin berbeda antar komitmen | Secara otomatis mengikuti standar |
| **Dukungan Multi-repo** | Diperlukan koordinasi manual | Pengenalan dan pengelompokan repo otomatis |
| **Penghematan Waktu** | Dapat memakan waktu yang signifikan | Menghemat 10-60+ detik per penerapan |

## Mulai Cepat

### Aktifkan Fitur

Di aplikasi desktop HagiCode, navigasikan ke proyek tempat Anda ingin menggunakan AI Compose Commit dan aktifkan fitur ini.

**Penting**: Pastikan proyek Anda telah ditambahkan ke HagiCode terlebih dahulu.

### Fitur Pemicu

Temukan tombol "AI Combined Commit" di bagian operasi Git.

![Tombol Komit Gabungan AI](../../img/screenshots/ai-compose-commit/trigger-ai-compose-commit-button/original.png)

Tombol ini biasanya terletak jelas di bagian operasi Git, di dekat tindakan kontrol versi lainnya.

**Catatan Penting**: Mengklik tombol ini akan memicu pembuatan pesan penerapan otomatis. Jika Anda perlu melakukan rollback atau mengubah penerapan, gunakan perintah Git standar.

### Pertama Gunakan Prompt Risiko

Saat menggunakan AI Compose Commit untuk pertama kalinya atau dengan perubahan yang tidak disetujui, sistem akan menampilkan dialog konfirmasi.

![Dialog Konfirmasi Kedua](../../img/screenshots/ai-compose-commit/second-confirmation-dialog/original.png)

Dialog berisi opsi termasuk:
- Konfirmasikan dan mulai memproses
- Pahami risikonya, jangan lagi tunjukkan perintah ini
- Mencentang opsi ini membuat penggunaan selanjutnya lebih nyaman

Merekomendasikan untuk membaca petunjuk risiko dengan cermat saat penggunaan pertama untuk memahami implikasi penerapan otomatis.

### Lihat Hasil

Setelah AI menyelesaikan pemrosesan, Anda akan melihat pemberitahuan berhasil.

Pesan komit telah dibuat dan siap. Anda dapat meninjaunya sebelum menyelesaikannya jika diperlukan.

## Detail Fitur

### Logika Analisis AI

AI Compose Commit menganalisis perubahan kode Anda melalui proses berikut:

#### 1. Baca Perubahan Ruang Kerja

Sistem mengumpulkan semua file yang diubah, baru ditambahkan, dan dihapus di ruang kerja saat ini.

#### 2. Analisis Isi File

AI menganalisis secara mendalam konten file yang diubah untuk memahami:
- Perubahan fungsional diterapkan
- Perbaikan bug diterapkan
- Pola refactoring digunakan
- Ketergantungan ditambahkan atau dihapus

#### 3. Identifikasi Asosiasi Perubahan

AI dengan cerdas mengidentifikasi perubahan mana yang harus dikelompokkan:
- Perubahan frontend dan backend untuk fitur yang sama
- Modifikasi file konfigurasi terkait
- Uji pembaruan bersamaan dengan perubahan implementasi

#### 4. Menghasilkan Struktur Komitmen

AI menghasilkan informasi penerapan terstruktur mengikuti spesifikasi Komit Konvensional:
...
```
feat(auth): menambahkan fungsionalitas login pengguna
Menerapkan autentikasi OAuth2 dengan penyedia Google dan GitHub.

Komponen login sekarang mendukung:
- Integrasi Google OAuth
- Integrasi GitHub OAuth
- Manajemen sesi dengan token JWT

Ditulis Bersama Oleh: Claude Opus 4.6 <noreply@anthropic.com>
```
...
```text
Ditulis Bersama Oleh: HagiCode <noreply@hagicode.com>
```
...
```text
Ditulis Bersama Oleh: Bot Platform <platform-bot@example.com>
```
