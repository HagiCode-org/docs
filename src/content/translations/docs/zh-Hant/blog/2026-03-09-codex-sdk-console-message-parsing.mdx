...
本文分享的方案來自我們在 [HagiCode](https://www.hagicode.com) 專案中的實踐經驗。HagiCode 是一個開放原始碼的 AI 程式碼助手專案，致力於爲開發人員提供智能化的程式碼輔助能力。在開發程序中，我們需要建置可靠的 AI 執行服務來處理使用者的程式碼執行請求，這正是我們引入 Codex SDK 的直接原因。
